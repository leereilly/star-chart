...
export { DEFAULT_AXIS_FONT_SIZE, DEFAULT_COLUMNS, DEFAULT_DUAL_THEME, DEFAULT_ROWS, MAX_REPOSITORIES, configDualTheme, configRepositories, normalizeChartConfig, normalizeChartModel, } from './config/defaults.js';
export type { ChartConfigInput, ChartModelInput } from './config/defaults.js';
export { LIGHT_PALETTE, DARK_PALETTE, basePalette, applyOverrides, } from './config/themes.js';
...
export { aggregateDisplayName, aggregateHistories, aggregateMetadata, } from './history/aggregate.js';
...
export { contribGeometry, columnHeight, tipClassFromTop, RenderError, } from './renderers/contributions.js';
export type { ContribFrame } from './renderers/contributions.js';
export { buildFrameSequence, frameTheme } from './renderers/frames.js';
export type { ChartFrame, FrameSequence, FrameOptions, } from './renderers/frames.js';
...
export { deriveDualPaths, validateOutputPath, outputFormat, PathValidationError, } from './utils/path.js';
export type { DualOutputPaths, OutputFormat } from './utils/path.js';
export { utcWeekStart } from './utils/dates.js';
export { INFINITE_GROWTH, OUTPUT_NAMES, buildOutputs, buildPictureSnippet, chartAltText, formatGrowthPercentage, outputEntries, } from './outputs.js';
export type { BuildOutputsOptions, PictureSnippetOptions } from './outputs.js';
export { ApiError } from './api/errors.js';
import type { NormalizedHistory, RepositoryMetadata, RepositoryHistorySource } from './models/index.js';
 ...
 */
export declare function renderStarChart(config: ChartConfigInput, metadata: RepositoryMetadata, history: NormalizedHistory, asOf: number): string;
/** Render independent repository sources, preserving aligned comparison data. */
export declare function renderMultiRepositoryStarChart(config: ChartConfigInput, sources: readonly RepositoryHistorySource[], asOf: number): string;
